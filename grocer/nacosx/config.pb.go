...
// 	protoc        v6.33.4
// source: grocer/nacosx/config.proto
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_grocer_nacosx_config_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_grocer_nacosx_config_proto_rawDescGZIP(), []int{0}
}
...
type Options struct {
	...
	Timeout              *durationpb.Duration     `protobuf:"bytes,30,opt,name=timeout,proto3" json:"timeout,omitempty"`                                                                                                              // timeout for requesting Nacos server, default value is 10000ms
	...
	GroupName            *wrapperspb.StringValue  `protobuf:"bytes,33,opt,name=group_name,json=groupName,proto3" json:"group_name,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *Options) Reset() {
	*x = Options{}
	mi := &file_grocer_nacosx_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Options) Descriptor() ([]byte, []int) {
	return file_grocer_nacosx_config_proto_rawDescGZIP(), []int{1}
}
...
func (x *Options) GetTimeout() *durationpb.Duration {
	if x != nil {
		return x.Timeout
	}
	return nil
...
func (x *Options) GetGroupName() *wrapperspb.StringValue {
	if x != nil {
		return x.GroupName
	}
	return nil
...
func (x *ClientLogSamplingConfig) Reset() {
	*x = ClientLogSamplingConfig{}
	mi := &file_grocer_nacosx_config_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClientLogSamplingConfig) Descriptor() ([]byte, []int) {
	return file_grocer_nacosx_config_proto_rawDescGZIP(), []int{2}
}
...
func (x *ClientLogRollingConfig) Reset() {
	*x = ClientLogRollingConfig{}
	mi := &file_grocer_nacosx_config_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClientLogRollingConfig) Descriptor() ([]byte, []int) {
	return file_grocer_nacosx_config_proto_rawDescGZIP(), []int{3}
}
...
var File_grocer_nacosx_config_proto protoreflect.FileDescriptor

const file_grocer_nacosx_config_proto_rawDesc = "" +
	"\n" +
	"\x1agrocer/nacosx/config.proto\x12\rgrocer.nacosx\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1agrocer/protobufx/tls.proto\"\x9a\x01\n" +
	"\x06Config\x12<\n" +
	"\aconfigs\x18\x01 \x03(\v2\".grocer.nacosx.Config.ConfigsEntryR\aconfigs\x1aR\n" +
	"\fConfigsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12,\n" +
	"\x05value\x18\x02 \x01(\v2\x16.grocer.nacosx.OptionsR\x05value:\x028\x01\"\xb5\x11\n" +
	"\aOptions\x124\n" +
	...
	"\fcluster_name\x18\x1d \x01(\v2\x1c.google.protobuf.StringValueR\vclusterName\x123\n" +
	...
	"\x0fapp_conn_labels\x18  \x03(\v2).grocer.nacosx.Options.AppConnLabelsEntryR\rappConnLabels\x12;\n" +
	"\n" +
	"group_name\x18! \x01(\v2\x1c.google.protobuf.StringValueR\tgroupName\x1a@\n" +
	...
	"\bcompress\x18\x06 \x01(\v2\x1a.google.protobuf.BoolValueR\bcompressB0Z.github.com/soyacen/grocer/grocer/nacosx;nacosxb\x06proto3"

var (
	file_grocer_nacosx_config_proto_rawDescOnce sync.Once
	file_grocer_nacosx_config_proto_rawDescData []byte
)

func file_grocer_nacosx_config_proto_rawDescGZIP() []byte {
	file_grocer_nacosx_config_proto_rawDescOnce.Do(func() {
		file_grocer_nacosx_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grocer_nacosx_config_proto_rawDesc), len(file_grocer_nacosx_config_proto_rawDesc)))
	})
	return file_grocer_nacosx_config_proto_rawDescData
}

var file_grocer_nacosx_config_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_grocer_nacosx_config_proto_goTypes = []any{
...
var file_grocer_nacosx_config_proto_depIdxs = []int32{
	...
	11, // 30: grocer.nacosx.Options.timeout:type_name -> google.protobuf.Duration
	...
	6,  // 33: grocer.nacosx.Options.group_name:type_name -> google.protobuf.StringValue
	9,  // 34: grocer.nacosx.ClientLogSamplingConfig.initial:type_name -> google.protobuf.Int32Value
	9,  // 35: grocer.nacosx.ClientLogSamplingConfig.there_after:type_name -> google.protobuf.Int32Value
	6,  // 36: grocer.nacosx.ClientLogRollingConfig.filename:type_name -> google.protobuf.StringValue
	9,  // 37: grocer.nacosx.ClientLogRollingConfig.max_size:type_name -> google.protobuf.Int32Value
	9,  // 38: grocer.nacosx.ClientLogRollingConfig.max_age:type_name -> google.protobuf.Int32Value
	9,  // 39: grocer.nacosx.ClientLogRollingConfig.max_backups:type_name -> google.protobuf.Int32Value
	8,  // 40: grocer.nacosx.ClientLogRollingConfig.local_time:type_name -> google.protobuf.BoolValue
	8,  // 41: grocer.nacosx.ClientLogRollingConfig.compress:type_name -> google.protobuf.BoolValue
	1,  // 42: grocer.nacosx.Config.ConfigsEntry.value:type_name -> grocer.nacosx.Options
...
func init() { file_grocer_nacosx_config_proto_init() }
func file_grocer_nacosx_config_proto_init() {
	if File_grocer_nacosx_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_grocer_nacosx_config_proto_rawDesc), len(file_grocer_nacosx_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_grocer_nacosx_config_proto_goTypes,
		DependencyIndexes: file_grocer_nacosx_config_proto_depIdxs,
		MessageInfos:      file_grocer_nacosx_config_proto_msgTypes,
	}.Build()
	File_grocer_nacosx_config_proto = out.File
	file_grocer_nacosx_config_proto_goTypes = nil
	file_grocer_nacosx_config_proto_depIdxs = nil
}
