...
// 	protoc        v6.33.4
// source: grocer/redisx/config.proto
...
func (x *Config) Reset() {
	*x = Config{}
	mi := &file_grocer_redisx_config_proto_msgTypes[0]
...
func (*Config) Descriptor() ([]byte, []int) {
	return file_grocer_redisx_config_proto_rawDescGZIP(), []int{0}
}
...
func (x *Options) Reset() {
	*x = Options{}
	mi := &file_grocer_redisx_config_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Options) Descriptor() ([]byte, []int) {
	return file_grocer_redisx_config_proto_rawDescGZIP(), []int{1}
}
...
func (x *Options_ClusterOptions) Reset() {
	*x = Options_ClusterOptions{}
	mi := &file_grocer_redisx_config_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Options_ClusterOptions) Descriptor() ([]byte, []int) {
	return file_grocer_redisx_config_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *Options_FailOverOptions) Reset() {
	*x = Options_FailOverOptions{}
	mi := &file_grocer_redisx_config_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Options_FailOverOptions) Descriptor() ([]byte, []int) {
	return file_grocer_redisx_config_proto_rawDescGZIP(), []int{1, 1}
}
...
func (x *Options_MaintNotificationsConfig) Reset() {
	*x = Options_MaintNotificationsConfig{}
	mi := &file_grocer_redisx_config_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Options_MaintNotificationsConfig) Descriptor() ([]byte, []int) {
	return file_grocer_redisx_config_proto_rawDescGZIP(), []int{1, 2}
}
...
var File_grocer_redisx_config_proto protoreflect.FileDescriptor

const file_grocer_redisx_config_proto_rawDesc = "" +
	"\n" +
	"\x1agrocer/redisx/config.proto\x12\rgrocer.redisx\x1a\x1egoogle/protobuf/duration.proto\x1a\x1egoogle/protobuf/wrappers.proto\x1a\x1agrocer/protobufx/tls.proto\"\x9a\x01\n" +
	"\x06Config\x12<\n" +
	...
	"\achannel\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\achannelB0Z.github.com/soyacen/grocer/grocer/redisx;redisxb\x06proto3"

var (
	file_grocer_redisx_config_proto_rawDescOnce sync.Once
	file_grocer_redisx_config_proto_rawDescData []byte
)

func file_grocer_redisx_config_proto_rawDescGZIP() []byte {
	file_grocer_redisx_config_proto_rawDescOnce.Do(func() {
		file_grocer_redisx_config_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_grocer_redisx_config_proto_rawDesc), len(file_grocer_redisx_config_proto_rawDesc)))
	})
	return file_grocer_redisx_config_proto_rawDescData
}

var file_grocer_redisx_config_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_grocer_redisx_config_proto_goTypes = []any{
...
var file_grocer_redisx_config_proto_depIdxs = []int32{
...
func init() { file_grocer_redisx_config_proto_init() }
func file_grocer_redisx_config_proto_init() {
	if File_grocer_redisx_config_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_grocer_redisx_config_proto_rawDesc), len(file_grocer_redisx_config_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_grocer_redisx_config_proto_goTypes,
		DependencyIndexes: file_grocer_redisx_config_proto_depIdxs,
		MessageInfos:      file_grocer_redisx_config_proto_msgTypes,
	}.Build()
	File_grocer_redisx_config_proto = out.File
	file_grocer_redisx_config_proto_goTypes = nil
	file_grocer_redisx_config_proto_depIdxs = nil
}
